...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv1 = (TextView)findViewById(R.id.underline1);
        TextView tv2 = (TextView)findViewById(R.id.underline2);
    ...
    public void makeCall(View view){
        makeToast("Fitur masih dalam tahap pengembangan.");

//        Intent callIntent = new Intent(Intent.ACTION_CALL);
//        callIntent.setData(Uri.parse("tel:0215732241"));

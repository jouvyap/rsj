...
public class DetilActivity extends ActionBarActivity {
    ...
    public void createLapor(View view){
        ...
        final EditText input = new EditText(DetilActivity.this);
        ...
        builder.setTitle(getString(R.string.action_lapor))
                ...
                .setMessage("Adukan keluhan Anda mengenai pelayanan atau fasilitas RS " +
                        "melalui fitur Lapor!")
                .setView(input)
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        lapor = "#LAPOR " + input.getText().toString() + " @LAPOR1708";
                        new PostTwitter().execute();
                    }
                })
    ...
    public void createKoreksi(View view){
        laporData = new ArrayList<>();
        AlertDialog.Builder builder = new AlertDialog.Builder(DetilActivity.this);
        builder.setTitle(getString(R.string.action_koreksi))
                .setIcon(R.mipmap.ic_launcher)
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "[Rumah Sakit Jakarta] Koreksi Data");
    ...
    private class PostTwitter extends AsyncTask<Void, Void, Void>{

        protected Void doInBackground(Void... voids) {
            String token ="3309850706-fb35IY9N5KbWLGEDGmfEMvj7ocop6s3IE4ew05S";
            String secret = "WTq5bTASUM0ZkZmBwgixGyEeDTaYHdTH8aSA6WnAluVOr";
            AccessToken a = new AccessToken(token,secret);
            Twitter twitter = new TwitterFactory().getInstance();
            twitter.setOAuthConsumer("Yl0UWRrgiglJSBikjKf7JM8Tn", "GwCANbejkyUIjNM3t8UrmO6hgftldIJ4cc5gqrnwpI8PVlagOq");
            twitter.setOAuthAccessToken(a);
            try {
                twitter.updateStatus(lapor);
        ...
        protected void onPostExecute(Void Result){
            makeToast("Berhasil dikirim ke Lapor!");
        }
    }
